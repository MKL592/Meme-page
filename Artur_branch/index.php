...
<body>
	...
	<header class="header-section">
			...
			<ul class="main-menu">
				<font color="white">
						<a href="login.php"><p class="btn"><font size="6" color="green">Zaloguj się</font></p></a>
						<a href="Baza_html.html"><p class="btn"><font size="6" color="green">Zajerestruj się</font></p></a>
				</font>
			</ul>
	</header>
	<!-- Header section end -->
